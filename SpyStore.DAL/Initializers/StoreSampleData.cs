    ...
    public static class StoreSampleData
    {
        ...
        public static List<Order> GetOrders(Customer customer, StoreContext context) => new List<Order>
        {
            new Order()
            {
                ...
                Details = GetOrderDetails(context)                
            }
        };
            ...
            Order order, StoreContext context)
        {
            ...
            {
                new OrderDetail() {Order = order, Product = prod1, Quantity = 3, UnitCost = prod1.UnitPrice},
                new OrderDetail() {Order = order, Product = prod2, Quantity = 2, UnitCost = prod2.UnitPrice},
                new OrderDetail() {Order = order, Product = prod3, Quantity = 5, UnitCost = prod3.UnitPrice},
            };
        }
            ...
            StoreContext context)
        {
            ...
            return new List<OrderDetail>
            {
                new OrderDetail() {Product = prod1, Quantity = 3, UnitCost = prod1.UnitPrice},
                new OrderDetail() {Product = prod2, Quantity = 2, UnitCost = prod2.UnitPrice},
                new OrderDetail() {Product = prod3, Quantity = 5, UnitCost = prod3.UnitPrice},
            };
        }
